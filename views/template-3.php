<div class="row">
  <div class="col-md-2">
    <a href="?article_id=<?php echo $articles[0]['id'] ?>">
  ...
  <div class="col-md-2">
    <div class="article up">
      <a href="?article_id=<?= $articles[3]['id'] ?>">
        <div class="image" style="background-image:url(<?php echo $articles[3]['imagePath'] ?>);">&nbsp;</div>
        <div class="text <?php echo $articles[3]['color']; ?>">
          <strong><?php echo $articles[3]['title'] ?></strong>
          <p><?php echo $articles[3]['excerpt'] ?></p>
        </div>
      </a>
    </div>
  </div>
  <div class="col-md-4">
    <div class="article down">
      <a href="?article_id=<?= $articles[4]['id'] ?>">
        <div class="text <?php echo $articles[4]['color']; ?>">
          <strong><?php echo $articles[4]['title'] ?></strong>
          <p><?php echo $articles[4]['excerpt'] ?></p>
        </div>
        <div class="image" style="background-image:url(<?php echo $articles[4]['imagePath'] ?>);">&nbsp;</div>
      </a>
    </div>
  </div>
</div>
